...
import sty from "./PlasmicService.module.css"; // plasmic-import: r0i5iKZJoiOv/css
...
const PlasmicDescendants = {
  root: ["root", "name", "freeBox", "price", "description"],
  name: ["name"],
  freeBox: ["freeBox"],
  price: ["price"],
